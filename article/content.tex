...
Despite the subtle discrepancies, the original model by far demonstrates that all the major results using the 2-D and 3-D model were implemented correctly. 
